#Overlap realtime view with correction using Perspective transformation matrix
#Output view reduce
...
if __name__ == "__main__":
    ...
    # Define the perspective transformation matrix from your earlier result
    perspective_matrix = np.array([[ 9.17643781e-01, -1.06331927e-01,  2.06641642e+02],
    ...
    while True:
        ...
        # Apply the perspective transformation to frame1
        frame1_transformed = cv2.warpPerspective(frame1, perspective_matrix, (frame1.shape[1], frame1.shape[0]))
        ...
        if key == ord("q"):
            ...
            if not is_recording:
                # Start recording
                video_filename = os.path.join("/home/lab902/Videos", "recording2.avi")
